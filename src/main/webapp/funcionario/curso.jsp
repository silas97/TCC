            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/funcionario/cadastrar-curso.jsp"
                                    class="btn btn-default">Cadastrar Curso</a>
                            </li>
                            <br>
                            <li><a href="${pageContext.request.contextPath}/funcionario/listar-curso.jsp"
                                    class="btn btn-default">Listar Cursos</a>
                            </li>
                        </ul>
                    </div>
                </div>
