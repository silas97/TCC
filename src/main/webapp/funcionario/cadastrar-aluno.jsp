        ...
        <div class="container" >
            ...
            <div>
                <nav class="navbar navbar-expand-lg navbar-light bg-light mt-2 rounded">
                    ...
                    <form class="text-white border border-white rounded p-3" id="aluno" name="aluno" method="post" action="${pageContext.request.contextPath}/aluno">
                        ...
                        <button type="submit" id="btn_cadastrar" class="btn btn-light">Cadastrar</button>
