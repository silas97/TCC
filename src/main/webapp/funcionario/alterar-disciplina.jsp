...
<html>
    ...
    <body style="background-color: #0056b3">
        <div class="container" >
            ...
            <h2 class="mt-3 text-white">Atualizar Disciplina</h2>
            ...
            <form class="text-white border border-white rounded p-3" name="form_disciplina" method="post" action="${pageContext.request.contextPath}/disciplina">
                ...
                <div class="form-row">
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" required name="nome" value="${discipline.nome}" class="form-control" id="input_nome" placeholder="Nome">
                        <label for="input_creditos">Créditos</label>
                        <input type="text" required name="creditos" value="${discipline.creditos}" class="form-control" id="input_nome" placeholder="Créditos">
                        <label for="input_carga_horaria">Carga Horária</label>
                        <input type="text" required name="cargaHoraria" value="${discipline.cargaHoraria}" class="form-control" id="input_nome" placeholder="Carga Horária">
                        <label for="input_nome">Curso</label>
                        <select name="idCurso_FK" class="form-control">
                            <option value="${discipline.curso.idCurso}">${discipline.curso.nome}</option>
