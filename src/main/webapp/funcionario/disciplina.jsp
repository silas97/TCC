            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/funcionario/cadastrar-disciplina.jsp"
                                    class="btn btn-default">Cadastrar Disciplina</a>
                            </li>
                            <br>
                            <li><a href="${pageContext.request.contextPath}/funcionario/listar-disciplina.jsp"
                                    class="btn btn-default">Listar Disciplina</a>
                            </li>
                        </ul>
                    </div>
                </div>
