            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/funcionario/cadastrar-turma.jsp"
                                    class="btn btn-default">Cadastrar Turma</a>
                            </li>
                            <br>
                            <li><a href="${pageContext.request.contextPath}/funcionario/listar-turma.jsp"
                                    class="btn btn-default">Listar Turma</a>
                            </li>
                        </ul>
                    </div>
                </div>
