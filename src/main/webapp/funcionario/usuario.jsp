                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul>
                                <li><a href="${pageContext.request.contextPath}/funcionario/cadastrar-usuario.jsp"
                                       class="btn btn-default">Cadastrar Usuário</a>
                                </li>
                                <br>
                                <li><a href="${pageContext.request.contextPath}/funcionario/listar-usuario.jsp"
                                       class="btn btn-default">Listar Usuário</a>
                                </li>
                            </ul>
                        </div>
                    </div>
